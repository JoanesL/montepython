...
class likelihood(object):
    ...
    #JO 2014
    #def add_string_spectra(self, cl, data):
        #Add string spectra normalized with (Gmu)^2
        
        #HEMEN MODUN BATEA IRAKURRI BEHARKO DO GMU, NUISANCE PARAMETER-EN ARTEAN
        
        # add normalized spectra
        # for l in range(2, self.l_max):
        #     exec "cl['tt'][l] += nuisance_value*self.%s_contamination[l]"
